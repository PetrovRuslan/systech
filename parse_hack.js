...
for (var item in result){
    ...
    for (var prop in result[item]){
        ...
        if (js_result[item][v]){
            ...
            x++;
            // console.log(js_result[item][v][x]);
            // console.log(result[item][prop].price * result[item][prop].quantity);
            js_result[item][v][x]['total'] = result[item][prop].price * result[item][prop].quantity;
...
for (var item in result){
    ...
    for (var prop in result[item]){        
        ...
        if (js_result[item][v]){
            // console.log(js_result[item][v]);
            js_result[item][v].push(result[item][prop]);
            // js_result[item][v][prop]['total'] = js_result[item][v][prop].price * js_result[item][v][prop].quantity;
            // console.log(js_result[item][v][prop]);
            // console.log(result[item][prop].price);
            console.log(js_result[item][v][prop].price);
            js_result[item][v]['itemQuant'] = js_result[item][v].length;
            summ += result[item][prop].price * result[item][prop].quantity;
            sum += result[item][prop].price * result[item][prop].quantity;
            js_result[item][v]['sumDoc'] = rounded(sum);
